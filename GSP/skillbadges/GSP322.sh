...
echo "${CYAN}${BOLD}        WELCOME TO HyperByteTech CLOUD TUTORIALS           ${RESET}"
echo "${CYAN}${BOLD}╚════════════════════════════════════════════════════════╝${RESET}"
echo
echo "${MAGENTA}${BOLD}         Tutorial by HyperByteTech              ${RESET}"
echo "${YELLOW}For more GCP tutorials, visit: ${UNDERLINE}https://youtube.com/@hyperbytetech-g4o?si=xtOvPz00bsMStAsw{RESET}"
echo
